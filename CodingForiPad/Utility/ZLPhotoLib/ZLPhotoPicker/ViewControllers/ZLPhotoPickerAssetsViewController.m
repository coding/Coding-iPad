...
- (UIButton *)doneBtn
{
    if (!_doneBtn) {
        ...
        [rightBtn setTitleColor:[UIColor colorWithRed:0/255.0 green:198/255.0 blue:12/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (ZLPhotoPickerCollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        CGFloat cellW = (self.view.frame.size.width - 4 - CELL_MARGIN * CELL_ROW + 1) / CELL_ROW;
        ...
        collectionView.contentInset = UIEdgeInsetsMake(5, 2, TOOLBAR_HEIGHT, 2);
...
- (void)viewDidLoad
{
    ...
    self.view.bounds = kScreen_Bounds;
