...
- (DACircularProgressView *)progressView
{
    if (!_progressView) {
        ...
        progressView.center = CGPointMake(kScreen_Width * 0.5, kScreen_Height * 0.5);
...
- (void)setPhoto:(ZLPhotoPickerBrowserPhoto *)photo
{
    ...
    if (photo.photoURL.absoluteString.length) {
        ...
        if (photoRange.location != NSNotFound){
            ...
            // 网络URL
            [_photoImageView sd_setImageWithURL:photo.photoURL placeholderImage:thumbImage options:SDWebImageRetryFailed|SDWebImageHandleCookies progress:^(NSInteger receivedSize, NSInteger expectedSize) {
